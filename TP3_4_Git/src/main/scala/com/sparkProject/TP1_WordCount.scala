...
object TP1_WordCount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df_wordCount = sc.textFile("/home/vaio/spark-2.2.0-bin-hadoop2.7/README.md")
    ...
    val df_wordCount_light = sc.textFile("/home/vaio/spark-2.2.0-bin-hadoop2.7/README.md")
    ...
    val df_wordCount_lighter = sc.textFile("/home/vaio/spark-2.2.0-bin-hadoop2.7/README.md") // output RDD of lines : RDD[String]
    ...
    val df_wordCount_lightest = sc.textFile("/home/vaio/spark-2.2.0-bin-hadoop2.7/README.md")
      .flatMap(_.split(" "))
      .map((_, 1))
      .reduceByKey(_ + _)
      .toDF("word", "count")
