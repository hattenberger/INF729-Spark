...
object TP3_4_Trainer_Test {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /******************************************************
      *
      * Ce fichier traite des questions Q1 à Q4 avant la création du pipeline
      * Il contient aussi quelques tests et affichage pour ma compréhension du TP
      * La version condensée avec le pipeline et les 8 Stage se trouve dans
      * le fichier TP3_4_Trainer_Pipeline_Q5
      *
      *******************************************************************/
